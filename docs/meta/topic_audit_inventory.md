...
| 0.25_Strategy_Power_Economics | core | Structured | A | 3 | 3 | 3 | 2 | 1 | 3 | source-locked U.S. historical panel | Package Tier A only; 20 lane-scoped gates govern the 15-wave program, legacy proxies fail corrected baselines, and global evidence is blocked | complete systematic review, rebuild measurement/KLEMS panels, then causal and external replication |
