...
| 0 | `0.25_Strategy_Power_Economics` | Structured | A | source-locked U.S. historical panel | present | 0_25_uet_economics_verification.json:WARN | - | - | Close the energy-density definition gate and retain Claim Class C until external replication. |
