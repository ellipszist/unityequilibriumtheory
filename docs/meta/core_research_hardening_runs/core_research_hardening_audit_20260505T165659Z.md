...
| 6 | `0.26_Cosmic_Dynamic_Frame` | Draft | B | real source referenced | present | 0_26_cosmic_dynamic_frame_verification.json:WARN | - | solved | Upgrade DATA_MANIFEST.md with source, local path, unit convention, and benchmark role. |
...
| 2 | `0.10_Fluid_Dynamics_Chaos` | Structured | B | manifested real dataset | present | PASS present | - | theorem-level | Downgrade README wording to match verifier and formula-audit status. |
