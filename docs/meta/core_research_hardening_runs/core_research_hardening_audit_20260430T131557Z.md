...
- Topics with bootstrap/open formula audits: 3
...
| 8 | `0.3_Cosmology_Hubble_Tension` | Structured | B | manifested real dataset | present/open | PASS present | - | solved | Close open formula-audit entries or keep matching limitations explicit. |
