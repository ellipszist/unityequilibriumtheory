...
| 8 | `0.18_Mathnicry` | Draft | B | manual or placeholder | present | 0_18_mathnicry_verification.json:WARN | - | theorem-level | Upgrade DATA_MANIFEST.md with source, local path, unit convention, and benchmark role. |
