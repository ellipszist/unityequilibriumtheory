...
| 4 | `0.0_Grand_Unification` | Structured | C | manifested source-backed working dataset | present | 0_0_grand_unification_verification.json:WARN | - | - | Upgrade DATA_MANIFEST.md with source, local path, unit convention, and benchmark role. |
