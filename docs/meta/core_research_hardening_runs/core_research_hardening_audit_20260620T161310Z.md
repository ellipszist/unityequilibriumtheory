...
| --: | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| 10 | `0.4_Superconductivity_Superfluids` | Draft | B | real source referenced | present | FAIL present | - | - | Narrow current FAIL via Vanadium lambda_ep and mu_star convention review (row_source_mapping_and_convention_gate); do not change threshold or verifier contract without new evidence. |
