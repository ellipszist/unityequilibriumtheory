...
| 2 | `0.13_Thermodynamic_Bridge` | Draft | B | manifested real dataset | present | 0_13_core_thermodynamic_constraint_gate.json:BLOCKED; 0_13_thermodynamic_bridge_verification.json:WARN; cattaneo_benchmark_artifact.json:SIMULATION_ONLY | - | solved | Downgrade README wording to match verifier and formula-audit status. |
