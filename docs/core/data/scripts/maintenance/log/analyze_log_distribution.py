...
def main():
    ...
    # Save to CSV
    csv_path = Path("docs/scripts/maintenance/log_analysis_report.csv")
    ...
    # Save to JSON
    json_path = Path("docs/scripts/maintenance/log_analysis_report.json")
