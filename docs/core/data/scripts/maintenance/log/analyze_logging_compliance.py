...
class LoggingComplianceAnalyzer:
    def __init__(self):
        self.topics_root = Path("docs/topics")
    ...
    def save_csv_report(self, report: Dict[str, Any]):
        """Save CSV report."""
        csv_file = Path("docs/scripts/maintenance/log/logging_compliance_report.csv")
    ...
    def save_json_report(self, report: Dict[str, Any]):
        """Save JSON report."""
        json_file = Path("docs/scripts/maintenance/log/logging_compliance_report.json")
