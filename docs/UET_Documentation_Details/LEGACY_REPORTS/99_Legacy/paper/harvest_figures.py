...
# Configuration
SOURCE_ROOT = Path(r"c:\Users\santa\Desktop\lad\Lab_uet_harness_v0.8.7\docs\topics")
DEST_DIR = Path(r"c:\Users\santa\Desktop\lad\Lab_uet_harness_v0.8.7\docs\paper\Figures")
