...
```mermaid
graph LR
    A[UET Engine] -- 1. Proofs/Shares --> B[Mining Pool]
    B -- 2. Payouts --> C[Digital Wallet]
    C -- 3. Transfer --> D[Exchange]
    D -- 4. Cash Out --> E[Bank Account]
```
...
- Open **[UET_Stratum_Siege.py](file:///c:/Users/santa/Desktop/lad/Lab_uet_harness_v0.9.0/docs/topics/0.18_Mathnicry/Code/03_Research/UET_Stratum_Siege.py)**.
