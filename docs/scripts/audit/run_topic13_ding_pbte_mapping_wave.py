"""Run Topic 13 through the Ding PBTE source-formula mapping wave."""
...
def main() -> int:
    base_wave = run("run_topic13_gatech_source_independence_wave.py")
    if base_wave != 0:
        return base_wave

    for relative in (
        "audit_topic13_ding_pbte_energy_temperature_mapping.py",
        "sync_topic13_ding_pbte_mapping_into_energy_bridge.py",
        "sync_topic13_ding_pbte_mapping_gate.py",
