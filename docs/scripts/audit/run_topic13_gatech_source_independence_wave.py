"""Run Topic 13 through the Georgia Tech source-independence closure wave."""
...
def main() -> int:
    base_wave = run("run_topic13_full_bridge_core_ready_source_wave.py")
    if base_wave != 0:
        return base_wave

    for relative in (
        "audit_topic13_gatech_volumetric_cp_independence.py",
        "sync_topic13_gatech_volumetric_cp_no_go_gate.py",
