"""Add the thermal quadratic stability boundary to Topic 13 discovery."""
...
RESULT_ID = "T13_UET_O2_THERMAL_STABILITY_BOUNDARY"
LANE_KEY = "uet_o2_thermal_stability_boundary"


def main() -> int:
    text = TARGET.read_text(encoding="utf-8-sig")
    if RESULT_ID in text:
        print("TOPIC13_THERMAL_STABILITY_BOUNDARY_KEY_ALREADY_PRESENT")
        return 0
    anchors = (
    ...
    for anchor in anchors:
        if anchor in text:
            ...
            print("PASS_REPAIRED_TOPIC13_THERMAL_STABILITY_BOUNDARY_KEY")
            return 0
