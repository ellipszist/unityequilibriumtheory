"""Run the bounded Topic 13 formal bridge-boundary wave."""
...
COMMANDS = [
    "docs/scripts/audit/repair_topic13_formal_bridge_lane_key_mapping.py",
    "docs/scripts/audit/audit_topic13_formal_bridge_boundary.py",
    "docs/scripts/audit/run_topic13_full_bridge_wave.py",
    "docs/scripts/audit/sync_topic13_formal_bridge_boundary.py",
