...
def build() -> dict[str, Any]:
    ...
    return {
        ...
        "next_controller": "close foundation coverage, dimensional units and observable maps; run the source-locked thermal and external 3D C-density lanes before any downstream promotion",
    }
