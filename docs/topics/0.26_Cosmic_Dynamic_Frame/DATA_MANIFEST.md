...
| source_lock_manifest.json | `Data/03_Research/source_lock_manifest.json` | Topic-derived source-lock package tying local working copies to source records | Mixed local conventions declared per file | Connects verifier inputs to upstream source records | Present; SHA-256 `eb6c07a3cc54ca8d6de672f63f8bcbb4d4a0c0fafb0139ef0bba7b7986478816`; upgrades provenance but not physical claim class. |
