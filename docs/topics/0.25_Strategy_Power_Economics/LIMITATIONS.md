...
- The SEC recipient concordance matches only 17 exact unique name variants to 15 public issuers out of 1,285 unique names; 1,268 remain no-match. The sample is nonrepresentative and current-vintage issuer facts vary by fiscal year and tag availability. Profit, operating cash flow, capex, debt, dividends, and cash are accounting channels, not earmarked sources for a reported award or subaward dollar.
