...
> **File/Script:** `docs/topics/0.25_Strategy_Power_Economics/Code/03_Research/Research_Global_Market_Dynamics.py`
...
```mermaid
graph TD
    Energy["💰 Capital / Resources"] --> Engine["⚙️ Econ Engine (Axiom 4)"]
    Engine --> Distribution["⚖️ Wealth Distribution (Pareto)"]
    Engine --> Conflict["⚔️ Strategy / Power Play"]
    Distribution --> Stability["🏰 Social Stability"]
