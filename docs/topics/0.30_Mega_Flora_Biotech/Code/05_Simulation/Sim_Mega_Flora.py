...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_flora_profile.json"
    ...
    print(f"Topic 0.30_Mega_Flora_Biotech Sim Status: {result['metadata']['status']}")
    return result
