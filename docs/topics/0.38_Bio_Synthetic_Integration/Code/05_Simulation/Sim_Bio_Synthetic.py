...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_biosynth_profile.json"
    ...
    result = {
        "metadata": {
            ...
            "topic": "0.38_Bio_Synthetic_Integration",
    ...
    print(f"Topic 0.38_Bio_Synthetic_Integration Sim Status: {result['metadata']['status']}")
    return result
