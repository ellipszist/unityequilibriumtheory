...
- Topic-local Fermilab and Standard-Model comparison files plus competitor scripts.
...
- absolute or relative residual on the reported anomaly value and discrepancy-to-baseline comparison
