...
- Artifact target:
  ...
  - embedded `muon_g2_claim_scope_gate` in `Result/artifacts/muon_g2_2025_validation.json`
- Interpretation:
  ...
  - Treat `muon_g2_claim_scope_gate` as the artifact-level controller for what the PASS may export to integration topics.
