...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_ocean_profile.json"
    ...
    print(f"Topic 0.29_Ocean_Recovery Sim Status: {result['metadata']['status']}")
    return result
