...
> **File/Script:** `docs/topics/0.29_Ocean_Recovery/Code/01_Engine/Engine_Ocean_Cooling.py`
...
```mermaid
graph TD
    Surface["☀️ Surface Heat (32°C)"] --> Structure["🏗️ Gyroid Heat Sink"]
    Structure --> Anchor["⚓ Thermal Anchor (-1.7°C)"]
    Structure --> Current["🌊 Chimney Flow (Passive Cooling)"]
