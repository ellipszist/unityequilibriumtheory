...
- The predictive-v1 operator residual gate exports `3` same-source-family He I diagnostic rows with locked-parameter and no-fit flags, but accepted `delta_uet_or_ci` operators remain `0`.
