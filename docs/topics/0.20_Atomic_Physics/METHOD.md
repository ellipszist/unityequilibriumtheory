...
| Neutral helium / many-electron targets | `helium_many_electron_sources.json`, artifacts `helium_many_electron_gate`, `helium_transition_assignment_gap_gate` | source package plus photon-energy blocker diagnostic; model blocked |
...
14. Load neutral helium source rows, compute photon energies, and blocker-gate missing upper/lower term assignments before any residual model.
...
- Neutral helium rows support source targets and photon-energy bookkeeping only until source term assignments, a two-electron Hamiltonian, correlation treatment, term mapping, and residual thresholds are added.
...
- Neutral helium source-package readiness and photon-energy blocker language for future many-electron artifacts.
