...
- Nonrelativistic and leading Dirac 1S-2S baseline frequencies, residual Hz, residual ppm, and sigma offsets against source measurement uncertainty.
...
- precision baseline and leading Dirac residual values with explicit model-incomplete status
