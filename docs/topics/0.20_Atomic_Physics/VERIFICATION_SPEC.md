...
- Atomic predictive-v1 operator-implementation-provenance required-evidence count, ready count, blocking count, accepted-operator count, and linked acceptance-decision blocker count.
...
- atomic predictive-v1 operator-implementation-provenance manifest, required evidence rows, evidence-path status, forbidden provenance shortcuts, blocker counts, next required artifacts, and provenance-only claim boundary
