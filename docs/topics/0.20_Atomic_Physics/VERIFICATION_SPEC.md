...
- Helium external-holdout acquisition candidate source count, raw file count, raw file hash count, overlap-line candidate count, blocked requirement count, selected candidate ID, and source-lineage review status.
