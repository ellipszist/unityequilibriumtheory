...
- Helium external-holdout acquisition candidate source count, overlap-line candidate count, blocked requirement count, selected candidate ID, and source-lineage review status.
