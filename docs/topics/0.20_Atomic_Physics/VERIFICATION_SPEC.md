...
- Helium external-holdout residual cross-check row count, skipped row count, maximum wavelength delta in A/ppm, maximum upper-energy delta in cm^-1, and blocked requirement count.
