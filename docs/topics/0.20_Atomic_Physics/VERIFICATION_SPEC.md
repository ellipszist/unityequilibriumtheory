...
- atomic predictive-v1 operator-implementation-provenance manifest, required evidence rows, forbidden provenance shortcuts, blocker counts, next required artifacts, and provenance-only claim boundary
