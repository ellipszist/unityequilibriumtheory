...
| Primary verifier script | `Code/03_Research/Research_Rydberg_Validation.py` | 50931 | `967a6202fe74e9578c54b32073e0819e9929990e1a1838e8a292697e5580dea7` | Topic-local verifier | n/a | hydrogen Rydberg benchmark verifier | Generates primary artifact, source gates, formula bridge, rounded level benchmark, selected ion benchmark, precision source gate, and neutral-helium source gate. |
| Primary verifier artifact | `Result/artifacts/0_20_atomic_physics_verification.json` | 29735 | `90eb5466684b6e7cabc3cb70bb4ac12e3c61108dc022cb5dd8f4b7adb611d1c6` | Generated by primary verifier | n/a | hydrogen Rydberg benchmark artifact | `PASS` for hydrogen, rounded level-energy, and provisional selected He+/Li2+ benchmark; precision spectroscopy and neutral helium are source-ready/model-blocked; controller remains `WARN`. |
