...
| Atomic formula bridge manifest | `Data/03_Research/atomic_formula_bridge_manifest.json` | 4422 | `297abc4c49e377fa6ae9c646e4308e547ac1e6b3951ef81063c6cd9a41c86ce1` | Generated by primary verifier | n/a | Bohr/de Broglie/Rydberg bridge manifest | Maps inherited standard formulas, the 1S-2S precision baseline gap, and UET dependencies without claiming first-principles derivation. |
| Primary verifier script | `Code/03_Research/Research_Rydberg_Validation.py` | 55373 | `7bcf9c6d28dcab716d30fa4dc1e5036f54ff5a33cdeccc2afdf7d6bd82466608` | Topic-local verifier | n/a | hydrogen Rydberg benchmark verifier | Generates primary artifact, source gates, formula bridge, rounded level benchmark, selected ion benchmark, precision source gate, 1S-2S baseline gate, and neutral-helium source gate. |
| Primary verifier artifact | `Result/artifacts/0_20_atomic_physics_verification.json` | 32321 | `aa187a3315ecf79902f917cae2d36b3b97d35eb9080cec9cf0584a71372002de` | Generated by primary verifier | n/a | hydrogen Rydberg benchmark artifact | `PASS` for hydrogen, rounded level-energy, and provisional selected He+/Li2+ benchmark; 1S-2S baseline residual is computed but model-incomplete; precision spectroscopy and neutral helium are source-ready/model-blocked; controller remains `WARN`. |
...
- It records 1S-2S, Lamb shift, and 21 cm hyperfine as precision source targets, then computes only the nonrelativistic 1S-2S Rydberg baseline residual.
...
- Hydrogen benchmark, rounded level-energy benchmark, formula bridge, selected He+/Li2+ reduced-mass results, precision source package, 1S-2S baseline residual diagnostic, and neutral-helium source package cannot be used as evidence for UET-derived `R_H`, broad hydrogen-like ion validation, neutral-helium residual validation, fine-structure, Lamb-shift, hyperfine/QED correction, periodic-table spectra, or many-electron claims.
