...
| Topic source evidence readiness matrix | `Data/03_Research/source_evidence_readiness_matrix.json` | Generated by primary verifier | n/a | source-review readiness gate | Current rows remain blocked for non-hydrogen lanes. |
| Topic branch claim gate | `Data/03_Research/branch_claim_gate.json` | Generated by primary verifier | n/a | claim ceiling for hydrogen and future atomic branches | Prevents hydrogen benchmark success from inflating full atomic-theory claims. |
