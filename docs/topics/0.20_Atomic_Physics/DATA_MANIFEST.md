...
| Topic source evidence intake stub | `Data/03_Research/source_evidence_intake_stub.json` | 2522 | `aacb7cb3e1d1e2da8867a2578f014299dc0d11e15312bdf1f554ee2295221410` | Generated by primary verifier | n/a | provenance workflow intake | Organizes source-review work before claim upgrades, including hydrogen-like ion source-lock. |
| Topic source evidence readiness matrix | `Data/03_Research/source_evidence_readiness_matrix.json` | 3160 | `3bdca9946c37e1b3f90e10d7b98f1b79f245c4db091d80563c887c99613e7264` | Generated by primary verifier | n/a | source-review readiness gate | Current rows remain blocked for hydrogen-like, precision, and many-electron lanes. |
| Topic branch claim gate | `Data/03_Research/branch_claim_gate.json` | 3228 | `25f2c6b0cb1abba93c2e79018cb67dc121d0514ed1554bff3c7e667d627296d3` | Generated by primary verifier | n/a | claim ceiling for hydrogen and future atomic branches | Prevents hydrogen benchmark and formula-bridge success from inflating full atomic-theory claims. |
...
| Primary verifier script | `Code/03_Research/Research_Rydberg_Validation.py` | 34994 | `25c9bdfb07e21f56cfd04fe0ad6df7b4dc54ac984428e6ceb1201fc8a5010c4d` | Topic-local verifier | n/a | hydrogen Rydberg benchmark verifier | Generates primary artifact, source gates, formula bridge, and checkpoint predictions. |
| Primary verifier artifact | `Result/artifacts/0_20_atomic_physics_verification.json` | 14334 | `8280a0b7aae828c0c24fda4b8f3da994b88eaf3f4bda20d5b155ce8f14cd814c` | Generated by primary verifier | n/a | hydrogen Rydberg benchmark artifact | `PASS` for hydrogen benchmark only; formula bridge is manifest-only; controller remains `WARN`. |
...
- It emits simple hydrogen-like `Z^2` checkpoint predictions for H, He+, and Li2+ while keeping non-hydrogen rows as prediction-only.
...
- Hydrogen benchmark and formula bridge results cannot be used as evidence for UET-derived `R_H`, hydrogen-like ion validation, helium, fine-structure, Lamb-shift, or many-electron claims.
