...
| Atomic formula bridge manifest | `Data/03_Research/atomic_formula_bridge_manifest.json` | 4893 | `2d868b8d507ac22d4a2effab2a79bbea479dcf9047b339cff642c17694da1bf8` | Generated by primary verifier | n/a | Bohr/de Broglie/Rydberg bridge manifest | Maps inherited standard formulas, nonrelativistic/Dirac 1S-2S precision baseline gaps, and UET dependencies without claiming first-principles derivation. |
| Primary verifier script | `Code/03_Research/Research_Rydberg_Validation.py` | 60420 | `a90ffbd4de0871d972b07c5dea7268cbe5206a5be4beea023da28626546e7e01` | Topic-local verifier | n/a | hydrogen Rydberg benchmark verifier | Generates primary artifact, source gates, formula bridge, rounded level benchmark, selected ion benchmark, precision source gate, 1S-2S baseline gates, and neutral-helium source gate. |
| Primary verifier artifact | `Result/artifacts/0_20_atomic_physics_verification.json` | 35147 | `c7f51ead6c7bc4bd1b74ceeb0797a74911289fdbad90568b52950c519716702b` | Generated by primary verifier | n/a | hydrogen Rydberg benchmark artifact | `PASS` for hydrogen, rounded level-energy, and provisional selected He+/Li2+ benchmark; nonrelativistic and leading Dirac 1S-2S baseline residuals are computed but QED-incomplete; precision spectroscopy and neutral helium are source-ready/model-blocked; controller remains `WARN`. |
...
- It records 1S-2S, Lamb shift, and 21 cm hyperfine as precision source targets, then computes nonrelativistic and leading Dirac 1S-2S baseline residuals.
...
- Hydrogen benchmark, rounded level-energy benchmark, formula bridge, selected He+/Li2+ reduced-mass results, precision source package, 1S-2S baseline residual diagnostics, and neutral-helium source package cannot be used as evidence for UET-derived `R_H`, broad hydrogen-like ion validation, neutral-helium residual validation, Lamb-shift, hyperfine/QED correction, periodic-table spectra, or many-electron claims.
