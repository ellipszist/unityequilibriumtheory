...
| Precision spectroscopy | Source package plus baseline diagnostic | `Data/03_Research/hydrogen_precision_spectroscopy_sources.json`, `precision_spectroscopy_gate` and `precision_baseline_gate` in artifact | 1S-2S, Lamb shift, and 21 cm hyperfine targets are organized; the nonrelativistic 1S-2S Rydberg baseline residual is computed. | Baseline residual is about 22.99 GHz (`~9.32 ppm`) and is not a Dirac/QED/recoil/proton-radius/hyperfine closure. |
