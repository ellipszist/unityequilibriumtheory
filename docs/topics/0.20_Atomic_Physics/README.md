...
| Precision spectroscopy | Source package plus baseline diagnostics | `Data/03_Research/hydrogen_precision_spectroscopy_sources.json`, `precision_spectroscopy_gate`, `precision_baseline_gate`, and `precision_dirac_baseline_gate` in artifact | 1S-2S, Lamb shift, and 21 cm hyperfine targets are organized; nonrelativistic and leading Dirac 1S-2S residuals are computed. | Nonrelativistic residual is about 22.99 GHz (`~9.32 ppm`); leading Dirac residual is about 7.10 GHz (`~2.88 ppm`) and still excludes Lamb/QED/recoil/proton-size closure. |
