...
- Neutral helium rows are source-package targets with photon energies computed only. Upper/lower term assignments, two-electron Hamiltonian, correlation treatment, term mapping, and many-electron residual model are not primary-gated yet.
