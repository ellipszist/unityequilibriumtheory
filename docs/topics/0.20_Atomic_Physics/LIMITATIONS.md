...
- Precision spectroscopy rows for 1S-2S, Lamb shift, and 21 cm hyperfine support source-package targets and a nonrelativistic 1S-2S baseline residual diagnostic only. No Dirac/QED/recoil/proton-radius/hyperfine residual model is primary-gated yet.
