...
- Precision spectroscopy rows for 1S-2S, Lamb shift, and 21 cm hyperfine support source-package targets plus nonrelativistic and leading Dirac 1S-2S baseline residual diagnostics only. No QED/recoil/proton-radius/hyperfine residual model is primary-gated yet.
