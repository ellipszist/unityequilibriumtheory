...
- Precision spectroscopy rows for 1S-2S, Lamb shift, and 21 cm hyperfine support source-package targets plus nonrelativistic, leading Dirac, and empirical Lamb-handoff 1S-2S residual diagnostics only. No first-principles QED/recoil/proton-radius/hyperfine residual model is primary-gated yet.
