...
- Required workflow gates:
  ...
  - embedded `neutrino_claim_scope_gate` in `Result/artifacts/nufit_6_0_validation.json`
- Interpretation:
  ...
  - Treat `neutrino_claim_scope_gate` as the artifact-level controller for what the PASS may export to integration topics.
