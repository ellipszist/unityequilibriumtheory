...
- NuFit working files, beta-decay inputs, and cited neutrino references.
...
- angle residuals, mass-splitting residuals, and fit mismatch on selected neutrino observables
