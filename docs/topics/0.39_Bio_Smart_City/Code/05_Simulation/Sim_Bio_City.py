...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_city_profile.json"
    ...
    print(f"Topic 0.39_Bio_Smart_City Sim Status: {result['metadata']['status']}")
    return result
