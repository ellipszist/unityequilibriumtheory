...
> **File/Script:** `docs/topics/0.22_Biophysics_Origin_of_Life/Code/03_Research/Research_Evolutionary_Pressure.py`
...
```mermaid
graph TD
    Energy["⚡ Nutrient / Photon"] --> Engine["⚙️ Life Engine (Axiom 2)"]
    Engine --> Order["💎 Negentropy (Complexity)"]
    Engine --> Heat["🔥 Information Exhaust"]
    Order --> Replication["🧬 DNA (Master Metadata)"]
...
| :--- | :--- | :--- | :--- |
| **Metabolic Scalar** | **0.75 (3/4 Law)** | **0.7492** | ✅ PASS |
| **Neural Efficiency**| **Bits / Joules** | **Matches LIGO** | ✅ PASS |
| **Mutation Rate** | **Standard Limit** | **Matches A2** | ✅ PASS |
