# Physical & Engineering Limitations: 0.28_Material_Synthesis

This document outlines the known boundaries, physical assumptions, and experimental limitations of Material Synthesis & High-Pressure Hydrides.

## 1. Physical Boundaries & Edge Cases
- **Key Limitations:** High-pressure diamond anvil cell constraints, ambient temperature decay rates
