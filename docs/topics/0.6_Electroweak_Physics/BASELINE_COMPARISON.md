...
- LEP-style topic inputs, decay tables, and cited electroweak reference files.
...
- relative error on selected electroweak ratios, decay observables, and benchmark residuals
