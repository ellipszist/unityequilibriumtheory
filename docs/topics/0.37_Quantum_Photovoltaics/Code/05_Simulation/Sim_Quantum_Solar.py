...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_solar_profile.json"
    ...
    result = {
        "metadata": {
            ...
            "topic": "0.37_Quantum_Photovoltaics",
    ...
    print(f"Topic 0.37_Quantum_Photovoltaics Sim Status: {result['metadata']['status']}")
    return result
