...
*   [Engine_Solar_Paint.py](./Code/Engine_Solar_Paint.py) - Power density and harvesting simulation.
*   [Research_Fetch_Plasma_Properties.py](./Code/Research_Fetch_Plasma_Properties.py) - Real-time plasma data for Hot Zone harvesting.
