...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_orbital_profile.json"
    ...
    result = {
        "metadata": {
            ...
            "topic": "0.36_Orbital_Manufacturing",
    ...
    print(f"Topic 0.36_Orbital_Manufacturing Sim Status: {result['metadata']['status']}")
    return result
