...
- Current data posture is an integration artifact dependency manifest, not a raw scientific dataset.
- No canonical topic-local raw dataset currently exists; the topic is data-backed only through subordinate artifact identities, hashes, and statuses.
