...
```mermaid
graph TD
    A1["A1: Information (Bit)"] --> A2["A2: Equilibrium (Flow)"]
    A2 --> A3["A3: Coupling (Kappa)"]
    A3 --> A4["A4: Complexity (Matter)"]
    A4 --> A5["A5: Horizon (Cosmos)"]
    A5 -- Feedback --> A1
    
    style A3 fill:#fff3e0,stroke:#e65100,stroke-width:4px
```
