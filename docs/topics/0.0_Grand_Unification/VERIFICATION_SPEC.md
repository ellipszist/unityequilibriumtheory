...
- Reported metrics:
  ...
  - subordinate claim-gate summaries where artifacts expose `galaxy_model_gate`, `foundation_claim_gate`, `scale_claim_gate`, `numeric_residual_gate`, `theorem_boundary_gate`, or `paper_readiness_gate`
