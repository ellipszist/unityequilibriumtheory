...
|:--|:--|--:|:--|:--|:--|
| integration dependency manifest | `Data/03_Research/integration_dependency_manifest.json` | 10905 | `1920acd581e2aaf514ce67c731ef476b1c19e8d0b770aaad707e1b8e56eda88a` | Topic-local integration manifest over subordinate artifacts | Defines delegated artifact paths, roles, metric bridges, and claim boundary for the primary `0.0` verifier. |
| source evidence intake stub | `Data/03_Research/source_evidence_intake_stub.json` | 2258 | `d267f10c7ee0350474168ecb3ef76b88041274915383136584cc469fadfc674b` | Generated by primary verifier | Organizes dependency-governance source-review work before claim upgrades. |
| source evidence readiness matrix | `Data/03_Research/source_evidence_readiness_matrix.json` | 2647 | `28976e6963033a863015171da6e1acf79f478befddf0ec14a43d8c5807ebbc18` | Generated by primary verifier | Readiness gate for integration evidence and closure work. |
| branch claim gate | `Data/03_Research/branch_claim_gate.json` | 2436 | `bacb54587f248a9a5137b1a0040cdf8e44b869ba7e61d743e4048403c44e3419` | Generated by primary verifier | Claim ceiling for integration and grand-unification branches. |
| subordinate claim-gate summaries | embedded in `Result/artifacts/0_0_grand_unification_verification.json` | Read from subordinate artifacts such as `0.1` `galaxy_model_gate`, `0.6` `branch_claim_gate`, `0.13` `foundation_claim_gate`, `0.18` `theorem_boundary_gate`, `0.23` `scale_claim_gate`, and `0.26` `numeric_residual_gate` | Carries nested blockers into the 0.0 paper-readiness gate instead of flattening them into PASS/WARN only. |
