...
| subordinate claim-gate summaries | embedded in `Result/artifacts/0_0_grand_unification_verification.json` | Read from subordinate artifacts such as `0.13` `foundation_claim_gate`, `0.18` `theorem_boundary_gate`, `0.23` `scale_claim_gate`, and `0.26` `numeric_residual_gate` | Carries nested blockers into the 0.0 paper-readiness gate instead of flattening them into PASS/WARN only. |
