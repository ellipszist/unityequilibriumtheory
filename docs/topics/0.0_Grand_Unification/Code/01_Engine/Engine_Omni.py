...
# 1. Gravity (Topic 0.1)
galaxy_path = (
    ROOT / "docs/topics/0.1_Galaxy_Rotation_Problem/Code/01_Engine/Engine_Galaxy_V3.py"
)
...
atomic_path = (
    ROOT / "docs/topics/0.20_Atomic_Physics/Code/01_Engine/Engine_Atomic_Hydrogen.py"
)
