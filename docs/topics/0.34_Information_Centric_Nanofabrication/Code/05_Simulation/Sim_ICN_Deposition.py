...
def run_simulation():
    data_file = topic_path / "Data" / "05_Simulation" / "empirical_nanofab_profile.json"
    ...
    print(f"Topic 0.34_Information_Centric_Nanofabrication Sim Status: {result['metadata']['status']}")
    return result
