    ...
    return {
        ...
        "source_targets": [
            ...
            },
            {
                ...
                "priority": "medium",
                "status_hint": "return_contract_fixed_diagnostic_only",
                "evidence_entries": [
                    "proof_script_path",
...
def build_source_evidence_readiness_matrix() -> dict:
    rows = [
        ...
        },
        {
            ...
            "pending_fields": [
                "benchmark_identity",
                "formal_derivation_benchmark",
            ],
            "ready_for_source_review": False,
            "blocking_reason": "The proof script now has a real pass/fail return contract and diagnostic artifact, but it remains a narrow proton-mass check rather than a formal confinement derivation.",
        },
    ]
    ...
    return {
        ...
        "branches": [
            ...
            },
            {
                ...
                "blocker_to_stronger_claim": "Source-linked inputs and a diagnostic verifier exist, but high source-package residuals block validation wording.",
            },
            {
                "branch": "QCD running branch",
                "status": "blocked_for_strong_claims",
                "allowed_usage_now": "Open diagnostic branch only.",
                "blocker_to_stronger_claim": "alpha_s_uet_v2 is smoke-tested after the data-shape fix, but a vetted alpha_s source package is still missing.",
            },
            {
                "branch": "Confinement proof branch",
                "status": "blocked_for_strong_claims",
                "allowed_usage_now": "Diagnostic proton-mass consistency gate only.",
                "blocker_to_stronger_claim": "Need a defensible derivation benchmark before any formal confinement proof claim.",
            },
        ],
    ...
    return {
        ...
        "qcd_hadron_confinement_gate": {
            ...
            "required_evidence": [
                ...
                "fixed QCD-running benchmark with source-locked alpha_s inputs",
                "dedicated hadron-mass verifier artifact",
                "formal confinement derivation benchmark",
            ],
        },
        "blocked_exports": [
