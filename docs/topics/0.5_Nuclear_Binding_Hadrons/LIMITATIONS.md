...
- `pdg_hadron_qcd_source_mapping_gate.json` shows that PDG 2025 quark and several hadron mass records are available locally, but the hadron/QCD scripts still use embedded snapshots or hardcoded tables.
