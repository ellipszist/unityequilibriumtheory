...
| `semf_coefficient_provenance_gate.json` | 5631 | `675817f13e401bf99eedc48b9fbe263c9f81a55b9ccf50c4e843656a377c85c5` | tracks SEMF coefficient, Yukawa, and rounded-constant provenance | local package ready; blocks parameter-free and first-principles claims until external source record and term policy are source-locked |
| `semf_coefficient_local_package.json` | 6631 | `62737400360e5b2f77885834c98d81768ad5117c761d3b756ac865a9f85d7ca5` | local package of exact engine SEMF/Yukawa constants | `LOCAL_PACKAGE_READY_SOURCE_GAP_BLOCKED`; 9 constants extracted, 0 gate mismatches, source record still missing |
...
| `Result/artifacts/nuclear_binding_source_locked_validation.json` | 19394 | `68e8a7e90fcae8530f290eaab933150f0efd645ce0ebe3610f96ed6551370112` | source-locked validation artifact | Supports heavy-nucleus subset and proton-radius anchor only; embeds SEMF decomposition, local SEMF package reference, SEMF coefficient gate status, and hadron/QCD/confinement diagnostic-blocked status |
| `Result/artifacts/semf_coefficient_provenance_diagnostic.json` | 4314 | `71bc06e023e17384e8376dcec85d196013ad81412e7f8ee4250690ef7bf3bef4` | SEMF coefficient local-package diagnostic | `LOCAL_PACKAGE_READY_SOURCE_GAP_BLOCKED`; 5 SEMF coefficients and 4 correction constants extracted from the engine with 0 local gate mismatches |
...
- The SEMF coefficient gate and local package now make the exact engine constants machine-readable and are embedded in the 2026-06-18 strict verifier artifact; source-record and term-policy blockers remain open.
