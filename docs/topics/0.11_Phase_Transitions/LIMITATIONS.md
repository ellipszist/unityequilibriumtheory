...
- Wave 43 extracts 19 TeX formula fragments from the three localized source archives and passes the source-formula fragment gate, but ccepted_estimator_policy_gate, uet_normalization_mapping_gate, and
ext_path_gate remain BLOCKED; no exponent, RG, universality, material, or Tier A claim is upgraded.
