...
| [0.11](./0.11_Phase_Transitions/) | `Draft` | `B` | spectral estimator work is active; Wave 26 blocks exponent claims on a missing source-backed or derived acceptance rule |
