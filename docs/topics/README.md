...
| [0.11](./0.11_Phase_Transitions/) | `Draft` | `B` | Wave 27 defines a structure-factor acceptance preflight; exponent claims remain blocked by consistency and estimator-reconciliation gates |
