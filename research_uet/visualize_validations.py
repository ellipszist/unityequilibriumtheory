...
TEST_RESULTS = {
    "Galaxies (SPARC)": {"pass_rate": 73, "error": 10.8, "data_points": 154},
    "Strong Force": {"pass_rate": 100, "error": 2.0, "data_points": 18},
    "Weak Force": {"pass_rate": 98, "error": 2.5, "data_points": 8},
    "Electromagnetism": {"pass_rate": 100, "error": 1.6, "data_points": 12},
    "Quantum": {"pass_rate": 100, "error": 0.0, "data_points": 4},
    "Superconductivity": {"pass_rate": 100, "error": 4.5, "data_points": 6},
    "Superfluidity": {"pass_rate": 100, "error": 0.0, "data_points": 1},
    "Josephson": {"pass_rate": 100, "error": 0.1, "data_points": 1},
    "Black Holes": {"pass_rate": 100, "error": 5.0, "data_points": 4},
    "Plasma": {"pass_rate": 100, "error": 0.0, "data_points": 2},
    "Cosmology": {"pass_rate": 100, "error": 3.0, "data_points": 3},
    "Cosmic History": {"pass_rate": 100, "error": 0.0, "data_points": 4},
}
...
def create_data_sources_chart():
    ...
    real_data = 11  # Tests using real experimental data
    total = 12
