...
# 1. วิเคราะห์สมมาตร
.venv\Scripts\python.exe research_uet/topics/0.23_Unity_Scale_Link/Code/05_Enhancement/Enhancement_Symmetry_Analysis.py

# 2. ทดสอบ U(1) gauge symmetry
.venv\Scripts\python.exe research_uet/topics/0.23_Unity_Scale_Link/Code/05_Enhancement/Enhancement_Noether_U1_Gauge.py

# 3. ทดสอบ Scale invariance
.venv\Scripts\python.exe research_uet/topics/0.23_Unity_Scale_Link/Code/05_Enhancement/Enhancement_Noether_Scale_Invariance.py

# 4. ทดสอบ Noether currents
.venv\Scripts\python.exe research_uet/topics/0.23_Unity_Scale_Link/Code/05_Enhancement/Enhancement_Noether_Currents.py
```
...
from research_uet.topics.0.23_Unity_Scale_Link.Code.Enhancement_Noether_U1_Gauge import U1GaugeEnhancement
