...
topic_path = ROOT / "research_uet" / "topics" / "0.33_High_Energy_Density_Battery_Materials"
engine_path = topic_path / "Code" / "01_Engine"
if str(engine_path) not in sys.path:
    sys.path.insert(0, str(engine_path))

from research_uet.core.uet_parameters import UETParameters, K_BOLTZMANN, E_CHARGE, get_params
try:
