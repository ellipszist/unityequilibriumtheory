...
# 03_Research -> Code -> 0.15_Cluster_Dynamics -> topics -> research_uet -> uet_harness (Project Root)
...
engine_path = root_dir / "research_uet" / "topics" / "0.15_Cluster_Dynamics" / "Code" / "01_Engine" / "Engine_Cluster_Dynamics.py"
...
def run_jwst_validation():
    ...
    data_path = root_dir / "research_uet/topics/0.15_Cluster_Dynamics/Data/03_Research/jwst_early_galaxies.json"
