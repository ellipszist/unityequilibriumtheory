...
## 2. Direct CPU Mining (Scientific PoUW)
Unlike traditional blockchains that use random hashing, UET mining is **functional** and **direct**.
- **The Engine**: Every machine running the UET platform utilizes `uet_core` to process data (posts, RAG, knowledge sync).
