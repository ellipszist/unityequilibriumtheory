...
> **Related:** [[29__SOCIAL_FEED_AND_PROFILES_SPEC_v1]] · [[31__WORKSPACE_AND_COLLABORATION_SPEC_v1]] · [[34__INTEGRATION_ARCHITECTURE_v1]] · [[28__OPEN_SOURCE_STACK_SELECTION_v1]]
...
## 6. Page-by-Page Layout Map (The 5 Heavy Pages)

| Route | Layout | Left Panel | Center | Right Panel |
|-------|--------|-----------|--------|-------------|
| `/news` | BentoGrid / AppShell | — | News Cards + Project Slides | — |
| `/workchat` | ThreePanelLayout | Source (Upload Docs) | Chat Agent | Studio (Noting & Tools) |
| `/community`| ThreePanelLayout | Profile (IG style: Bio/Story) | Community Feed (Posts) | Friends & Community Chat |
| `/project` | SidebarLayout | `Topic` Chats / Members / Voice | Shared Canvas / Folders (Obsidian style) | — |
| `/economy` | BentoGrid / AppShell | — | Global System Metrics | — |
| `/account` | BentoGrid / AppShell | — | Personal Metrics & Wallet | — |

**Secondary Pages:**
| Route | Layout | Notes |
|-------|--------|-------|
| `/install` | AppShell / Custom | Landing page (formerly Home) |
| `/manual` | SidebarLayout | Platform documentation (formerly Docs) |
| `/settings` | AppShell / Form | System settings & preferences |

> **Critical UI Rule for Three-Panel Layout:** The three columns MUST load **symmetrically (equal width)** on first render. Users can resize them afterwards, but the default state must be perfectly balanced.
---
...
|-------------|-------|-------|
| News | `/news` | Heavy Page: Academic updates & featured projects |
| WorkChat | `/workchat` | Heavy Page: AI assistant (NotebookLM style) |
| Community | `/community` | Heavy Page: Social feed & global chat (replaces Feed) |
| Project | `/project` | Heavy Page: Collaboration, topics, wallet (replaces Workspace) |
| Economy | `/economy` | Heavy Page: System KPI & Macro metrics |
| Account | `/account` | Heavy Page: Personal usage metrics & API keys |
| Install | `/install` | Entry point landing page |
| Manual | `/manual` | Platform documentation |
| Topic | — | Replaces "Channel" for project discussions |

> ⚠️ **Rule:** A page has exactly ONE name. Do not mix Legacy (Workspaces, Docs, Feed) and Current names.
